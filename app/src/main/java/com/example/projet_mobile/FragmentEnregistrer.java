...
public class FragmentEnregistrer extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        boutonEnregistrer.setOnClickListener(v -> {
            ...
            Intent Patients = new Intent(activity.getApplicationContext(), Patient.class);
            startActivity(Patients);
            Intent Medecins = new Intent(activity.getApplicationContext(), Medecin.class);
            startActivity(Medecins);
        });
    }
